...
const { replacePkgName, replaceDbContent,replacePkgAuthorName } = require('./helper')
...
module.exports = async (_projectType) => {
    ...
    switch (type) {
        case projectType["NPM_NODE"]:
            return console.log(chalk.red('npm modules project template for node in development :('))
